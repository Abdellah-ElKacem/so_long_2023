...
/*   Updated: 2023/02/01 18:06:30 by ael-kace         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_up(t_connect_data *data)
{
	...
	img.floor = mlx_xpm_file_to_image(data->mlx_ptr \
		, "./textures/floor.xpm", &dim, &dim);
	img.player_back = mlx_xpm_file_to_image(data->mlx_ptr \
		...
		&& data->map[data->player_y - 1][data->player_x] != 'E')
	{
		...
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr \
			, img.floor, data->player_x * 32, data->player_y * 32);
		data->player_y -= 1;
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr \
			, img.player_back, data->player_x * 32, data->player_y * 32);
		player_move(data);
	}
	else if (data->coin == 0
		&& data->map[data->player_y - 1][data->player_x] == 'E')
...
void	move_down(t_connect_data *data)
{
	...
	img.floor = mlx_xpm_file_to_image(data->mlx_ptr \
		, "./textures/floor.xpm", &dim, &dim);
	img.player = mlx_xpm_file_to_image(data->mlx_ptr \
		...
		&& data->map[data->player_y + 1][data->player_x] != 'E')
	{
		...
		data->player_y += 1;
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr \
			, img.player, data->player_x * 32, data->player_y * 32);
		player_move(data);
	}
	else if (data->coin == 0
		&& data->map[data->player_y + 1][data->player_x] == 'E')
...
void	move_right(t_connect_data *data)
{
	...
	img.floor = mlx_xpm_file_to_image(data->mlx_ptr \
		, "./textures/floor.xpm", &dim, &dim);
	img.player_right = mlx_xpm_file_to_image(data->mlx_ptr \
		...
		&& data->map[data->player_y][data->player_x + 1] != 'E')
	{
		...
		data->player_x += 1;
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr \
			, img.player_right, data->player_x * 32, data->player_y * 32);
		player_move(data);
	}
	else if (data->coin == 0
		&& data->map[data->player_y][data->player_x + 1] == 'E')
...
void	move_left(t_connect_data *data)
{
	...
	img.floor = mlx_xpm_file_to_image(data->mlx_ptr \
		, "./textures/floor.xpm", &dim, &dim);
	img.player_left = mlx_xpm_file_to_image(data->mlx_ptr \
		...
		&& data->map[data->player_y][data->player_x - 1] != 'E')
	{
		...
		data->player_x -= 1;
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr \
			, img.player_left, data->player_x * 32, data->player_y * 32);
		player_move(data);
	}
	else if (data->coin == 0
		&& data->map[data->player_y][data->player_x - 1] == 'E')
